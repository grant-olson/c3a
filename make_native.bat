...
ocamlopt %DEBUG% -o coa.exe -I +lablGL lablgl.cmxa lablglut.cmxa unix.cmxa oatools.cmxa  -intf c3aModels.alti -impl c3aModels.alt compOpponent.mli compOpponent.ml c3a.ml
