...
let pawn_black = Player.reskin_player [("h_head","models/players/orbb/red_h.tga");
...
let pawn_white = Player.reskin_player  [("h_head","models/players/orbb/blue_h.tga");
...
let knight_black = Player.reskin_player [("h_feathers","models/players/hunter/red_f.tga");
                                         ("h_head","models/players/hunter/red_h.tga");
                                         ("u_torso","models/players/hunter/red.tga");
                                         ("l_legs","models/players/hunter/red.tga");
                                        ] knight
let knight_white = Player.reskin_player [("h_feathers","models/players/hunter/red_f.tga");
...
let queen_black = Player.reskin_player [("h_glasses","models/players/mynx/red_s.tga");
                                        ("h_head","models/players/mynx/red_h.tga");
                                        ("u_arms","models/players/mynx/mynx.tga");
                                        ("u_torso","models/players/mynx/red_s.tga");
                                        ("l_legs","models/players/mynx/red_s.tga");
                                       ] queen
let queen_white = Player.reskin_player [("h_glasses","models/players/mynx/blue_s.tga");
                                        ("h_head","models/players/mynx/red_h.tga");
                                        ("u_arms","models/players/mynx/mynx.tga");
...
let bishop_black = Player.reskin_player [("h_head","models/players/slash/red_h.tga");
...
let bishop_white = Player.reskin_player [("h_head","models/players/slash/blue_h.tga");
...
let rook_black = Player.reskin_player [("h_head","models/players/tankjr/red.tga");
...
let rook_white = Player.reskin_player [("h_head","models/players/tankjr/blue.tga");
...
let king_black = Player.reskin_player [("h_head","models/players/xaero/red_h.tga");
...
let king_white = Player.reskin_player [("h_head","models/players/xaero/blue_h.tga");
                                       ("u_armbase","models/players/xaero/xaero_a.tga");
                                      ("u_quill01","models/players/xaero/xaero_q.tga");
                                      ("u_quill02","models/players/xaero/xaero_q.tga");
                                      ("u_quill03","models/players/xaero/xaero_q.tga");
